...
# Expected output:
# Kubernetes control plane is running at https://XXXXX.gr7.us-east-2.eks.amazonaws.com
# CoreDNS is running at https://XXXXX.gr7.us-east-2.eks.amazonaws.com/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
```
...
find base/deployments -name "*.yaml" -exec sed -i \
  's/AWS_ACCOUNT_ID/852140462703/g; s/AWS_REGION/us-east-2/g' {} \;
...
```yaml
annotations:
  alb.ingress.kubernetes.io/certificate-arn: arn:aws:acm:us-east-2:852140462703:certificate/xxxxx
```
    ...
    "Statement": [
      {
        ...
        "Resource": ["arn:aws:secretsmanager:us-east-2:852140462703:secret:argocd/*"]
      }
    ]
  }'
