...
2. **Verify IAM permissions:**
   ...
   aws eks describe-cluster --name demo-pre-prod-cluster --region us-east-2
   ```
...
aws secretsmanager get-secret-value --secret-id argocd/github-ssh-key --region us-east-2
