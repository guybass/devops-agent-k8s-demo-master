...
```json
{
  ...
  "engine": "postgres",
  "host": "demo-pre-prod-postgres.xxxxxx.us-east-1.rds.amazonaws.com",
  "port": "5432",
...
| Secret ARN | `arn:aws:secretsmanager:us-east-1:852140462703:secret:demo/pre-prod/redis` |
| Region | `us-east-1` |
| Encryption | AWS managed key |
  ...
  "Statement": [
    {
      ...
      "Condition": {
        "StringEquals": {
          "oidc.eks.us-east-1.amazonaws.com/id/OIDC_ID:sub": "system:serviceaccount:devops-agent-demo:external-secrets-sa",
...
aws secretsmanager rotate-secret \
  --secret-id demo/pre-prod/database \
  --rotation-lambda-arn arn:aws:lambda:us-east-1:852140462703:function:SecretRotationFunction \
