...
find base/deployments -name "*.yaml" -exec sed -i 's/AWS_REGION/us-east-1/g' {} \;

# Or use kustomize to set images
cd base
kustomize edit set image \
  AWS_ACCOUNT_ID.dkr.ecr.AWS_REGION.amazonaws.com/devops-agent-demo-api-gateway=123456789012.dkr.ecr.us-east-1.amazonaws.com/devops-agent-demo-api-gateway:latest
```
